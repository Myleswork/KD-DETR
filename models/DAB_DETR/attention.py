...
def multi_head_attention_forward(query: Tensor,
    ...
    before_softmax= attn_output_weights
    attn_output_weights = softmax(
    ...
    if need_weights:
        ...
        before_softmax = before_softmax.view(bsz, num_heads, tgt_len, src_len)
        before_softmax = before_softmax.sum(dim=1) / num_heads
        before_softmax = before_softmax.transpose(0, 1).contiguous()
        return attn_output, before_softmax 
    else:
